...
class PlateDataset(utils.Dataset):
    ...
    def load_plate(self, dataset_dir, subset):
        ...
        annotations = json.load(open(os.path.join(ROOT_DIR, "Plate-Detection.json")))
        ...
        for a in annotations:
            ...
            #polygons.append(a['regions'][0]['shape_attributes'])
...
def train(model):
    ...
    dataset_train.load_plate(args_dataset, "train")
    ...
    dataset_val.load_plate(args_dataset, "val")
    dataset_val.prepare()
    print("Done")
...
if __name__ == '__main__':
    ...
    weights_path = os.path.join(ROOT_DIR, "mask_rcnn_plate_0004.h5")
    args_dataset = os.path.join(ROOT_DIR, "Dataset")
